...
public class CheckboxDemoPage {
    ...
    public static void clickButtonCheckAll() {
        Common.clickElement(Locators.SeleniumEasy.CheckboxDemo.buttonCheckboxGroup);
    }

    public static String readValueOfUncheckAllButton() {
        return Common.getElementAttributeValue(Locators.SeleniumEasy.CheckboxDemo.buttonCheckboxGroup, "value");
    }

    public static boolean checkStatusesOfSelectedCheckboxes(boolean isStatusSet) {
        List<Boolean> statusList = Common.getStatusesOfSelectedCheckboxes(Locators.SeleniumEasy.CheckboxDemo.inputMultipleCheckbox);
